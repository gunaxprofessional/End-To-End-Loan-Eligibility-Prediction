...
applicant_income = st.slider('Applicant Income', min_value=150, max_value=150000, value=5000, step=100)
coapplicant_income = st.slider('Coapplicant Income', min_value=0, max_value=100000, value=0, step=100)
loan_amount = st.slider('Loan Amount', min_value=0, max_value=5000000, value=100, step=1)
